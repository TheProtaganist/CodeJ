...
%Task: make a function to reload a gui app by closing it and automatically reopening it.
%Code: 
...
//Task: Make a simple story with some primitives "Name", "age", and "Favorite hobby".
//Code:
fun main(args: Array<String>) {
    val name = "Tim" //string
    val age = 25 //int
...
HTML = """
<!--Task: Make a simple page to ask the user for a name and display "hello" plus the name with the text being 300 by 300 and in blue. Use <script> and </script> in the code Since we are using Java Script-->
<!--Code: -->
<html>
<head>
...
<!--Task: Make a yellow square in the center using css with the dimensions 200 by 200 -->
<!--Code: -->
<html>
<head>
...
<!--Task: Make a red square in the center using css with the dimensions 100 by 100-->
<!--Code: -->
<html>
<head>
