...
class Generation3:
    ...
    def generation(self, language, temperature, *args):
        ...
        def save_to_file(file_name, lang):
            path = f"completions/file_name"
            if not os.path.exists(path):
                os.makedirs(path)
            if lang == "MATLAB":
                with open(f"completions/MATLAB/{file_name}.m", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                ...
                with open(f"completions/Julia/{file_name}.jl", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/C#/{file_name}.cs", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/Python/{file_name}.py", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/C++/{file_name}.cpp", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/Q#/{file_name}.qs", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/F#/{file_name}.fs", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/JavaScript/{file_name}.js", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/Kotlin/{file_name}.kt", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/Dart/{file_name}.dart", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/Java/{file_name}.java", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/C/{file_name}.c", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + "\n")
                ...
                with open(f"completions/CSS/{file_name}.css", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                ...
                with open(f"completions/HTML/{file_name}.html", "w", encoding="UTF-8") as f:
                    Ins = gpt3_gen()[0]
                    Outs = gpt3_gen()[1]
                    for i in range(len(Ins)):
                        f.write(comment_token + Ins[i] + out_comment_token + "\n")
    ...
    def generate(self,  language, temperature, top_p, *args):
        ...
        def gptj_gen():
            ...
            for i in (list_of_examples):
                ...
                response = context_settings.completion(prompt=Prompt, user="User", bot="Coder", max_tokens=333, temperature=temperature, top_p=top_p)
                inputs.append(i)
